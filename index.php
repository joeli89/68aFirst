			  	...
			  	foreach($images as $project_id => $image) { ?>
				    ...
				    <li class="item <?php echo $image["class"]; ?> col-xs-4 no-padding">
				    	<a data-toggle="modal" href='<?php echo $image["link"]; ?>' data-target='#<?php echo $project_id; ?>'>
							<img src='<?php echo $image["img-thumb"]; ?>' alt="..." />
				    	...
				    	<!-- Modal -->
							<div class="modal fade" id='<?php echo $project_id; ?>' role="dialog" aria-hidden="true">
	...
	<section id="section6">
		...
		<div class="contact">
			...
			<div class="container">
				...
				<!-- Email -->
				<div class="col-md-3">
					<p class="contact-info-email"><a href="mailto:info@68adesigns.com"><em>info@68adesigns.com</em></a></p>
				</div>
